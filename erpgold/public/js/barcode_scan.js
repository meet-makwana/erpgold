	...
	erpnext.utils.BarcodeScanner = Class.extend({
            ...
            return new Promise((resolve, reject) => {
                ...
                this.scan_api_call(input, (r) => {
					...
					if (["Purchase Receipt", "Purchase Invoice"].includes(this.frm.doc.doctype)) {
						// For Purchase Receipt and Purchase Invoice, simply add the item without updating rate or showing alerts
                    ...
                    }else if(data.custom_is_jewellery_item==1){
		...
		update_table(data) {
			return new Promise(resolve => {
				...
				const {item_code, barcode, batch_no, serial_no, uom, warehouse, custom_labour_type, custom_is_jewellery_item,custom_sales_labour_rate, custom_sales_labour_amount, custom_mrp_rate, custom_purity_percentage, custom_less_weight, custom_metal_type, custom_other_amount, custom_gross_weight,custom_gold_rate, custom_fine_weight, custom_net_weight, custom_purity,custom_sales_order,custom_so_detail,custom_westage,custom_is_mrp_item} = data;
				if(data.is_jewellery_item==1){
					if(!data.custom_mrp_rate||this.frm.doc.doctype!="Stock Entry"){
						var posting_date =  this.frm.doc.posting_date
						if(this.frm.doc.doctype == "Sales Order" || this.frm.doc.doctype== "Purchase Order"){
							posting_date =  this.frm.doc.transaction_date
				...
				let row = this.get_row_to_modify_on_scan(item_code, batch_no,  uom, serial_no, barcode, warehouse, custom_labour_type, custom_is_jewellery_item, custom_sales_labour_rate, custom_sales_labour_amount, custom_mrp_rate, custom_purity_percentage, custom_less_weight, custom_metal_type,  custom_other_amount, custom_gross_weight,custom_gold_rate, custom_fine_weight, custom_net_weight, custom_purity,custom_sales_order,custom_so_detail,custom_westage,custom_is_mrp_item);
				...
				frappe.run_serially([
					...
					() => this.set_item(row, item_code, batch_no,  uom, serial_no, barcode, warehouse, custom_labour_type, custom_is_jewellery_item,  custom_sales_labour_rate, custom_sales_labour_amount, custom_mrp_rate, custom_purity_percentage, custom_less_weight, custom_metal_type,  custom_other_amount, custom_gross_weight,custom_gold_rate, custom_fine_weight, custom_net_weight, custom_purity,custom_sales_order,custom_so_detail,custom_westage,custom_is_mrp_item).then(qty => {
		...
		set_item(row, item_code, batch_no,  uom, serial_no, barcode, warehouse, custom_labour_type, custom_is_jewellery_item,  custom_sales_labour_rate, custom_sales_labour_amount, custom_mrp_rate, custom_purity_percentage, custom_less_weight, custom_metal_type,  custom_other_amount, custom_gross_weight,custom_gold_rate, custom_fine_weight, custom_net_weight, custom_purity,custom_sales_order,custom_so_detail,custom_westage,custom_is_mrp_item) {
			return new Promise(resolve => {
				const increment = async (value = 1) => {
					...
					const item_data = {item_code: item_code,custom_labour_type:custom_labour_type, custom_is_jewellery_item:custom_is_jewellery_item,custom_sales_labour_rate:custom_sales_labour_rate, custom_sales_labour_amount:custom_sales_labour_amount,  custom_purity_percentage:custom_purity_percentage, custom_less_weight:custom_less_weight, custom_metal_type:custom_metal_type,  custom_other_amount:custom_other_amount,custom_gold_rate:custom_gold_rate, custom_gross_weight:custom_gross_weight, custom_fine_weight:custom_fine_weight, fine_weight:custom_fine_weight, custom_mrp_rate:custom_mrp_rate, custom_net_weight:custom_net_weight, custom_purity:custom_purity, custom_sales_order:custom_sales_order , custom_so_detail:custom_so_detail,custom_westage:custom_westage,custom_is_mrp_item:custom_is_mrp_item};
		...
		add_child_for_remaining_qty(prev_row) {
			if (this.remaining_qty && this.remaining_qty >0) {
				...
				for (let key in prev_row) {
					if (in_list(ignore_fields, key)) {              // nosemgrep
						continue;
					}
		...
		show_scan_message(idx, exist = null, qty = 1) {CRG00005
